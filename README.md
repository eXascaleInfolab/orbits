...
- **Algorithms**: The full benchmark contains 14 recovery algorithms (all but 2 rewritten in C++). We enable the 8 most relevant algorithms: ORBITS (cdrec), TKCM, SPIRIT, GROUSE, OGDImpute, SSA, M-RNN and pcaMME. To enable the full set of algorithms, please refer to the *Algorithms customization* section below.
