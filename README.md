...
- **Scenarios**: The benchmark will execute the full set of 15 different recovery scenarios (streaming and batch) using RMSE, MSE and MAE metrics. It will also generate all the error and recovery plots.
...
- **Results**: The accuracy results will be sequentially added for each scenario and dataset to the subfolder:  `Plots/precision/../error/results/values/`. The runtime results will be added to: `Plots/runtime/../results/`.
