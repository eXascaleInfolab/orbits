...
- **Scenarios**: The benchmark will execute the full set of 15 different recovery scenarios using RMSE, MSE and MAE metrics, and generate all the corresponding plots (streaming and batch).
