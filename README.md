...
- **Algorithms**: The benchmark evaluates the following algorithms: ORBITS, SPIRIT, GROUSE, OGDImpute, pcaMME, TKCM and M-RNN<sup>*</sup> (<sup>*</sup>disabled by default as it takes too long to run). To enable/disbale any algorithm, please refer to the *Algorithms customization* section below.
- **Datasets**: The full benchmark evaluates 4 different datasets: gas (drfit10), motion, bafu and soccer<sup>*</sup> (<sup>*</sup>disabled by default, as it takes too long to run). To enable/disbale any dataset, please refer to the *Datasets customization* section below.
...
- **Results**: All the results will be added to a new folder `Results/`. The accuracy results of all algorithms will be sequentially added for each scenario and dataset to:  `Results/.../.../.../error/`. The runtime results of all algorithms will be placed together with precision into: `Results/.../.../.../runtime/`.
