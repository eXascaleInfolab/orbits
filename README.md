...
- **Algorithms**: The full benchmark contains 14 recovery algorithms (all but 2 are rewritten in C++). We enable by default the 7 most relevant online algorithms: ORBITS, SPIRIT, GROUSE, OGDImpute, pcaMME, TKCM and M-RNN. To enable any additional algorithm, please refer to the *Algorithms customization* section below.
- **Datasets**: The full benchmark contains 10 different datasets. We enable by default 3 datasets: gas, motion and bafu. To enable soccer (or any additional dataset), please refer to the *Datasets customization* section below.
