...
- **Datasets**: The full benchmark contains 10 different datasets. By default, only the 4 most relevant datasets will be evaluated: gas (drfit10), motion, bafu and soccer. To enable/disbale any dataset, please refer to the *Datasets customization* section below.
