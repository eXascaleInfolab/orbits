...
- **Results**: All the results will be added to the folder `Plots/`. The accuracy results of all algorithms will be sequentially added for each scenario and dataset to:  `Plots/precision/../../../error/results/values/`. The runtime results of all algorithms will be added to: `Plots/runtime/../../../results/`.
