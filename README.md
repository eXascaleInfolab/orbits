...
- **Datasets**: The full benchmark contains 4 different datasets: gas (drfit10), motion, bafu and soccer (disabled by default, as it takes too long to run). To enable/disbale any dataset, please refer to the *Datasets customization* section below.
